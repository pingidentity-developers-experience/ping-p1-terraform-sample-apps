            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1"> {/* Registration UI. */}
                <form ref={this.form} onSubmit={e => e.preventDefault()}>
                  ...
                  <Row form className="form-row-light">
                    <Col md={12}>
                      <FormPassword handleFormInput={this.props.handleFormInput} autoComplete="off" name="password" label={content.form.fields.password.label} value={this.props.passwordValue} placeholder={content.form.fields.password.placeholder} />
                    </Col>
                  </Row>
                  <Row form className="form-row-light">
                    <Col md={12}>
                      <FormPassword handleFormInput={this.props.handleFormInput} autoComplete="off" name="password_confirm" label={content.form.fields.password_confirm.label} value={this.props.passwordConfirmValue} placeholder={content.form.fields.password_confirm.placeholder} />
                    </Col>
                  </Row>
                  <Row form className="form-row-light">
                    <Col md={12}>
                      <div className="text-center">
                        <Button type="button" color="primary" onClick={this.props.onSubmit}>{content.form.buttons.submit}</Button>
                        <Button type="button" color="link" className="ml-3" onClick={this.toggle.bind(this)}>{content.form.buttons.cancel}</Button>
                      </div>
                    </Col>
                  </Row>
                </form>
              ...
              <TabPane tabId="2"> {/* Registration email verification code UI. */}
                <form ref={this.formref2} onSubmit={e => e.preventDefault()}>
                  <h4>{content.form.buttons.reg_verification}</h4>
                  ...
                  <FormGroup className="form-group-light">
                    <Label for="regCode">{content.form.fields.regVerification.label}</Label>
                  ...
                  <div className="mb-3">
                    <Button type="button" color="primary" onClick={() => { this.handleUserAction("registration") }}>{content.form.buttons.reg_verification}</Button>
                  </div>
                </form>
              </TabPane>
            </TabContent>
